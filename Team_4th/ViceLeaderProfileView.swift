...
struct ViceLeaderProfileData: Codable {
    let teamid: Int
    let teamname: String
    let name: String
    let email: String
...
struct ViceLeaderProfileView: View {
        ...
        NavigationStack {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 20) {
                    ...
                    NavigationLink(destination: ViceManagementView(
                        teamname: teamName,
                        teams_id: teamID,
                        ...
                        Label("팀원 관리", systemImage: "plus.circle")
                            .frame(maxWidth: .infinity)
                            .padding()
                            .background(Color.black)
                            .foregroundColor(.white)
...
#Preview {
    ViceLeaderProfileView(showPersonalHome: .constant(false))
}
